...
INSERT INTO user (id, user_id, password, name, email, file_path) values (3, 'gunju', 'test', '건주', 'gunju@slipp.net', '/images/users/gunju.jpeg');
...
INSERT INTO question (id, writer_id, title, contents, create_date, deleted) VALUES (3, 1, '이 글은 삭제 되었습니다', CURRENT_TIMESTAMP(), true);

INSERT INTO question (id, writer_id, title, contents, create_date, deleted) VALUES (4, 1, '이 글은 답변이 없습니다', '이 글은 답변이 존재하지 않기 때문에 삭제 가능하다', CURRENT_TIMESTAMP(), false);
