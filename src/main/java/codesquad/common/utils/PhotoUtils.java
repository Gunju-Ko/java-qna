...
public class PhotoUtils {
    ...
    private static final String PHOTO_RESOURCE_PATH = String.format("/Users/skp/my/qna/%s/%s", IMAGE_DIRECTORY, USER_DIRECTORY);

    public static String userPhotoAbsolutePath(User user, ImageFormat imageFormat) {
